...
const Terms = ({ isLogged }) => {
  return (
      <Wrapper name='Terms'>
        ...
        <p>Le présent document a pour objet de définir les modalités et conditions dans lesquelles d’une part, DMFC-GAME, ci-après dénommé l’éditeur, met à la disposition de ses utilisateurs le site, et les services disponibles sur le site et d’autre part, la manière par laquelle l’utilisateur accède au site et utilise ses services.</p>
        <p>Toute connexion au site est subordonnée au respect des présentes conditions.</p>
        <p>Pour l’utilisateur, le simple accès au site de l’éditeur à l’adresse URL suivante http://dmfc-game.fr/  implique l’acceptation de l’ensemble des conditions décrites ci-après.</p>
        <h2>Propriété intellectuelle</h2>
        <p>Aucune reproduction, même partielle prévue à l’article L.122-5 du Code de la propriété intellectuelle, ne peut être faite de ce site sans l’autorisation de l'éditeur.</p>
